package com.framework.spring.dependency.client;
...
public class SpringDependencyTest01 {
  ...
  public static void main(String[] args) {
    ...
    XmlBeanFactory factory = new XmlBeanFactory(new ClassPathResource("applicationContext_dependency.xml")); 
    System.out.println("\n");
