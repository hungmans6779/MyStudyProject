 ...
 *  ※ 《一般呼叫》的範例
 *  
 *  對於服務提供者，可以只提供服務和對應的WSDL，是有些情況下，服務提供者會提供 SDK，這樣開發者就可以使用服務提供者的一些類別。
 *  例如 yahoo 的Web 服務不僅提供了服務，還提供了開發套件 SDK，下面就看一下這種方式的用戶端如何使用。
 *  
 */
public class HelloWebServiceClient {
  ...
  public static void main(String[] args) {
    ...
    try{
      ...
      String result = service.sayHello("Demo HelloWebService SDK 呼叫方式");
