...
package com.webservice.xfire.wsdl.helloWebServiceSignature.client;
...
/*
 *  根據 WSDL 產生的用戶端
 *  本例的WSDL： http://3w.eztravel.com.tw:8080/XFireDemo/services/HelloWebServiceSignature?wsdl
 *  
...
public class HelloWebServiceSignatureClient {
    ...
    public HelloWebServiceSignatureClient() {
        create0();
        Endpoint HelloWebServiceSignatureHttpPortEP = service0 .addEndpoint(new QName("http://xfire.webservice.com", "HelloWebServiceSignatureHttpPort"), new QName("http://xfire.webservice.com", "HelloWebServiceSignatureHttpBinding"), "http://3w.eztravel.com.tw:8080/XFireDemo/services/HelloWebServiceSignature");
    ...
    private void create0() {
        ...
        service0 = asf.create((com.webservice.xfire.wsdl.helloWebServiceSignature.client.HelloWebServiceSignaturePortType.class), props);
        {
