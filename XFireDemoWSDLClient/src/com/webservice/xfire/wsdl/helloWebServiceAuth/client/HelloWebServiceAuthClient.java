package com.webservice.xfire.wsdl.helloWebServiceAuth.client;
...
public class HelloWebServiceAuthClient {
  ...
  public HelloWebServiceAuthClient() {
    create0();
    Endpoint HelloWebServiceAuthHttpPortEP =
        service0.addEndpoint(
            new QName("http://xfire.webservice.com", "HelloWebServiceAuthHttpPort"), new QName(
                "http://xfire.webservice.com", "HelloWebServiceAuthHttpBinding"),
            "http://3w.eztravel.com.tw:8080/XFireDemo/services/HelloWebServiceAuth");
    endpoints.put(new QName("http://xfire.webservice.com", "HelloWebServiceAuthHttpPort"),
        HelloWebServiceAuthHttpPortEP);
    Endpoint HelloWebServiceAuthPortTypeLocalEndpointEP =
        service0.addEndpoint(new QName("http://xfire.webservice.com",
            "HelloWebServiceAuthPortTypeLocalEndpoint"), new QName("http://xfire.webservice.com",
            "HelloWebServiceAuthPortTypeLocalBinding"), "xfire.local://HelloWebServiceAuth");
    endpoints.put(new QName("http://xfire.webservice.com",
        "HelloWebServiceAuthPortTypeLocalEndpoint"), HelloWebServiceAuthPortTypeLocalEndpointEP);
  }
  ...
  private void create0() {
    ...
    service0 =
        asf.create(
            (com.webservice.xfire.wsdl.helloWebServiceAuth.client.HelloWebServiceAuthPortType.class),
            props);
    {
      AbstractSoapBinding soapBinding =
          asf.createSoap11Binding(service0, new QName("http://xfire.webservice.com",
              "HelloWebServiceAuthPortTypeLocalBinding"), "urn:xfire:transport:local");
    }
    {
      AbstractSoapBinding soapBinding =
          asf.createSoap11Binding(service0, new QName("http://xfire.webservice.com",
              "HelloWebServiceAuthHttpBinding"), "http://schemas.xmlsoap.org/soap/http");
    }
  }

  public HelloWebServiceAuthPortType getHelloWebServiceAuthHttpPort() {
    return ((HelloWebServiceAuthPortType) (this).getEndpoint(new QName(
        "http://xfire.webservice.com", "HelloWebServiceAuthHttpPort")));
  }
  ...
  public HelloWebServiceAuthPortType getHelloWebServiceAuthPortTypeLocalEndpoint() {
    return ((HelloWebServiceAuthPortType) (this).getEndpoint(new QName(
        "http://xfire.webservice.com", "HelloWebServiceAuthPortTypeLocalEndpoint")));
  }
  ...
  public static void main(String[] args) {
    ...
    // 呼叫服務
    String result = service.sayHello("Demo HelloWebServiceAuth WSDL 呼叫方式！！！");
